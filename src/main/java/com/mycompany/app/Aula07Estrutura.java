...
public class Aula07Estrutura {
    ...
    public static void main(String[] args) {
         ...
         * 
         * Seu tamanho e fixo, onde o primeiro elemento ocupa a posição 0 e o 
         * último sendo n - 1, onde n é o número total de elementos
         * todo array tem tipo associado
         */
        ...
        numeros[0] = 5; // Atribui um valor para posição 1
        ...
        int matriz2[][] = { // Declarar uma matriz 2 x 3
            {1, 2, 2}
            {3, 2, 1}
