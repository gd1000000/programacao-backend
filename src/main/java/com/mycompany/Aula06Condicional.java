...
public class Aula06Condicional {
    public static void main(String[] args) {
        ...
        */
         ...
         * 
         * É similar ao if/else com a diferença que ele considere valores predefinidos
         * que serão observados em cada case (caso)
         * 
         * na sua estrutura ele analisa uma variavel, e considera dentre sua opções qual 
         * considera.
         ...
         * 
         * um exemplo seria uma pergunta de multipla escolha.
         */

         //Digitando textos em mais uma linha
         System.out.println(
                 "1) Verde, Amarelo e Azul, são cores que fazem parte da bandeira de qual pais?\n" + //
